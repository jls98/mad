...
#define ACCESS_AMOUNT 1048576 // 2^20

//#define ADRS_AMOUNT 262144 // 2^18
//#define ADRS_AMOUNT 131072 // 2^17
#define ADRS_AMOUNT16 65536 // 2^16
#define ADRS_AMOUNT15 32768 // 2^15
#define ADRS_AMOUNT14 16384 // 2^14 significantly more misses above
#define ADRS_AMOUNT13 8192 // 2^13 works 
#define ADRS_AMOUNT12 4096 // 2^12 works
#define ADRS_AMOUNT11 2048 // 2^11 works
#define ADRS_AMOUNT10 1024 // 2^10 works
#define ADRS_AMOUNT9 512 // 2^9 works
...
int main(){
	...
	//L1_detection(ADRS_AMOUNT11);
	//L1_detection(ADRS_AMOUNT12);
	
	/*printf("task 1\n");
	L1_detection(ADRS_AMOUNT13);
	L1_detection(ADRS_AMOUNT14); // 30 avg 
	L1_detection(ADRS_AMOUNT15); // 32 avg 
	L1_detection(ADRS_AMOUNT16); // 37 avg
	*/
	/*
	printf("task 2\n");
